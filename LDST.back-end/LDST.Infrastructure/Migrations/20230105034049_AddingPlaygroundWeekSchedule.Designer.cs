...
namespace LDST.Infrastructure.Migrations
{
    ...
    [Migration("20230105034049_AddingPlaygroundWeekSchedule")]
    partial class AddingPlaygroundWeekSchedule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LDST.Domain.EFModels.PlaygroundEntity", b =>
                {
                    ...
                    b.OwnsOne("LDST.Domain.Models.WeekSchedule", "WeekSchedule", b1 =>
                        {
                            b1.Property<int>("PlaygroundEntityId")
                                .HasColumnType("integer");

                            b1.HasKey("PlaygroundEntityId");

                            b1.ToTable("Playgrounds");

                            b1.WithOwner()
                                .HasForeignKey("PlaygroundEntityId");

                            b1.OwnsMany("LDST.Domain.Models.DaySchedule", "Days", b2 =>
                                {
                                    b2.Property<int>("WeekSchedulePlaygroundEntityId")
                                        .HasColumnType("integer");
                                    ...
                                    b2.HasKey("WeekSchedulePlaygroundEntityId", "Id");

                                    b2.ToTable("DaySchedule");

                                    b2.WithOwner()
                                        .HasForeignKey("WeekSchedulePlaygroundEntityId");
                                });
